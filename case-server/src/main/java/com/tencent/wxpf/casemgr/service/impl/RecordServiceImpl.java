...
import com.tencent.wxpf.casemgr.constants.enums.EnvEnum;
import com.tencent.wxpf.casemgr.constants.enums.StatusCode;
import com.tencent.wxpf.casemgr.entity.dto.MergeCaseDto;
import com.tencent.wxpf.casemgr.entity.dto.PickCaseDto;
...
import com.tencent.wxpf.casemgr.entity.xmind.IntCount;
import com.tencent.wxpf.casemgr.handler.Room;
import com.tencent.wxpf.casemgr.handler.WebSocket;
...
import com.tencent.wxpf.casemgr.util.BitBaseUtil;
...
import static com.tencent.wxpf.casemgr.constants.SystemConstant.EMPTY_STR;
import static com.tencent.wxpf.casemgr.constants.SystemConstant.NOT_DELETE;
import static com.tencent.wxpf.casemgr.util.TimeUtil.compareToOriginalDate;
...
public class RecordServiceImpl implements RecordService {
    ...
    public JSONObject getData(MergeCaseDto dto) {
        ...
        if (!StringUtils.isEmpty(dto.getChooseContent()) && !dto.getChooseContent().contains(OE_PICK_ALL)) {
            ...
            // 给未来的环境选择做好打算...
            if (dto.getEnv().equals(EnvEnum.TestQaEnv.getValue())
                    || dto.getEnv().equals(EnvEnum.TestRdEnv.getValue())) {
                // 似乎是想用BFS做广度遍历
                JSONObject caseRoot = content.getJSONObject("root");
                Stack<JSONObject> objCheck = new Stack<>();
                Stack<IntCount> iCheck = new Stack<>();
